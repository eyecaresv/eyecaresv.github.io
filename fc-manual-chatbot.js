...
{{KNOWLEDGE}}`;
  ...
  const knowledgeBase = [
    ...
    {
      id: "eye-retinal-surgery",
      category: "施術可否",
      title: "網膜剥離・網膜裂孔・網膜復位術後の施術",
      keywords: ["網膜剥離", "網膜裂孔", "網膜復位術", "硝子体手術", "シリコン", "シリコーン", "ガス", "リング", "バンド", "手術後", "6ヶ月", "半年"],
      answer:
        "網膜剥離、網膜裂孔、硝子体手術、網膜復位術後のお客様は、基本的に術後6ヶ月以上空けるのが安全です。ガスやシリコーンオイルを使っている場合があり、網膜の再剥離リスクは術後1ヶ月・3ヶ月・6ヶ月に高いとされています。6ヶ月経過していれば基本的には施術可能と考えられますが、自然に再剥離が起こる可能性もあるため、事前説明と主治医確認を推奨してください。",
      structured: {
        title: "網膜系手術後の施術",
        conclusion: "基本は術後6ヶ月以上空けるのが安全です。",
        reason: "網膜の再剥離リスクは術後1ヶ月・3ヶ月・6ヶ月が高く、6ヶ月以降は起こりにくくなるためです。",
        note: "6ヶ月経過後でも、自然に再剥離が起こる可能性は説明し、主治医確認を推奨してください。",
        detail:
          "対象例は、網膜剥離、網膜裂孔、硝子体手術、網膜復位術、眼内ガス・シリコーンオイル使用、バンドを巻く手術などです。担当医に確認しづらい場合は、本部へ相談してください。",
        nextQuestions: ["緑内障の施術可否は？", "白内障手術後はいつから？", "硝子体出血後はいつから？", "施術前の確認事項は？"],
      },
    },
    {
      id: "eye-glaucoma-treatment",
      category: "施術可否",
      title: "緑内障・レーザー治療後の施術",
      keywords: ["緑内障", "眼圧", "レーザー", "レーザー治療", "手術後", "3ヶ月", "1ヶ月", "失明", "ぼやける"],
      answer:
        "緑内障のお客様は、主治医の許可があれば施術可能と考えられます。緑内障で注意が必要なのは手術後で、術後3ヶ月は空けるのが安全です。レーザー治療の場合は、1ヶ月経過していれば基本的に大丈夫とされています。進行を遅らせたい、眼圧を下げたいなどのニーズがある場合も、主治医確認と安全説明を優先してください。",
      structured: {
        title: "緑内障の施術可否",
        conclusion: "主治医の許可があれば施術可能。手術後は3ヶ月、レーザー後は1ヶ月が目安です。",
        reason: "緑内障そのものよりも、手術直後の状態に注意が必要なためです。",
        note: "片目失明や視界ぼやけなど症状が強い場合は、主治医確認を優先してください。",
        detail:
          "緑内障で眼科通院中のお客様でも、主治医許可があれば対応可能とされています。手術後は3ヶ月空ける、レーザー治療後は1ヶ月経過が目安です。",
        nextQuestions: ["網膜剥離後はいつから？", "白内障手術後は？", "涙点プラグは大丈夫？", "眼病の施術可否を教えて"],
      },
    },
    {
      id: "eye-cataract-diabetic-floaters",
      category: "施術可否",
      title: "白内障・糖尿病網膜症・飛蚊症レーザー後",
      keywords: ["白内障", "糖尿病網膜症", "飛蚊症", "レーザー照射", "レーザー", "手術", "3ヶ月", "1ヶ月", "出血"],
      answer:
        "白内障手術後と糖尿病網膜症の手術後は、術後3ヶ月を空けるのが目安です。飛蚊症のレーザー照射後は、1ヶ月経過していれば基本的に大丈夫とされています。ただし糖尿病網膜症で手術まで受けている方は、施術と関係なく眼内出血が自然に起こる可能性があるため、事前説明をしておくのが無難です。",
      structured: {
        title: "白内障・糖尿病網膜症・飛蚊症レーザー",
        conclusion: "白内障・糖尿病網膜症手術後は3ヶ月、飛蚊症レーザー後は1ヶ月が目安です。",
        reason: "術後の安定期間を確保し、自然に起こり得る出血や再発との切り分けをしやすくするためです。",
        note: "糖尿病網膜症では、施術と関係なく眼内出血が起こる可能性を事前説明してください。",
        detail:
          "白内障、糖尿病網膜症は術後3ヶ月。飛蚊症のレーザー照射は1ヶ月が目安です。症状や主治医指示がある場合は、主治医確認を優先します。",
        nextQuestions: ["硝子体出血後は？", "網膜剥離後は？", "緑内障は大丈夫？", "施術前の確認事項は？"],
      },
    },
    {
      id: "eye-vitreous-pvd-dryeye",
      category: "施術可否",
      title: "硝子体出血・硝子体剥離・ドライアイ関連",
      keywords: ["硝子体出血", "硝子体剥離", "後部硝子体剥離", "飛蚊症", "ドライアイ", "涙点プラグ", "角膜クロスリンキング", "角膜クロスランキング", "クロスリンキング"],
      answer:
        "硝子体出血は、手術がある場合は3ヶ月、手術がない場合でも1ヶ月程度空けるのが目安です。ただし一度出血した方は、施術と関係なく出血を繰り返す可能性があるため、事前に説明してください。硝子体剥離は、主治医から特段の注意がなく飛蚊症のみであれば施術は問題ないとされています。涙点プラグや角膜クロスリンキング後は、経過していれば基本的に大きな注意は不要とされています。",
      structured: {
        title: "硝子体・ドライアイ関連",
        conclusion: "硝子体出血は手術あり3ヶ月、手術なし1ヶ月が目安。硝子体剥離・涙点プラグは基本的に施術可能です。",
        reason: "出血経験がある場合は自然再出血の可能性があり、硝子体剥離や涙点プラグは施術自体のリスクが低いとされているためです。",
        note: "主治医から施術不可の指示がある場合や症状が強い場合は、施術せず本部へ確認してください。",
        detail:
          "硝子体剥離は加齢によるもので、飛蚊症のみ・主治医から注意事項なしであれば問題ないとされています。涙点プラグは涙が溜まりやすく、涙が増える体感につながる可能性があります。",
        nextQuestions: ["網膜剥離後は？", "白内障手術後は？", "眼病の施術可否を教えて", "施術前の確認事項は？"],
      },
    },
    {
      id: "memoric-child",
    ...
    {
      id: "subscription-service-obligation-report",
      category: "会計・システム",
      title: "サブスクの役務と入金報告",
      keywords: ["サブスク", "役務", "役務報告", "役務カウント", "入金報告", "入金額", "客報", "契約日", "QRコード", "14000", "Square売上"],
      answer:
        "サブスクは役務報告のカウント不要です。役務は、回数券と初回クーポン4980円など、入金後にどれくらい消化できているかを把握するために入力します。サブスクは毎月払って毎月消化するため、役務として溜まらず、役務報告は不要です。入金があった時点、つまり契約日・QRコードを読み取った日に、客報の入金額へ14,000円を入力します。その後、毎月サブスクに上がってくる分はSquare売上に上がるため、これまで通りPCのSquareからその日の売上を入力してください。",
      structured: {
        title: "サブスク役務・入金報告",
        conclusion: "サブスクは役務カウントなしで大丈夫です。",
        reason: "役務は、回数券や初回クーポンなど、入金後にどれくらい消化できているかを見るための報告です。サブスクは毎月支払い・毎月消化のため、役務として溜まりません。",
        note: "契約日、つまりQRコードを読み取った日に、客報の入金額へ14,000円を入力します。",
        detail:
          "サブスクに毎月上がってくる分はSquare売上に上がるため、これまで通りPCのSquareからその日の売上を入力してください。役務が発生するのは、回数券と初回クーポン4980円などです。",
        nextQuestions: ["サブスクプラン変更時の客報は？", "サブスク登録方法は？", "サブスクの領収書は？", "SquareのPCログイン方法は？"],
      },
    },
    {
      id: "subscription-plan-change-report",
      category: "会計・システム",
      title: "サブスクプラン変更時の客報",
      keywords: ["サブスク", "プラン変更", "客報", "契約変更", "アップセル", "ダウンセル", "報告", "変更欄"],
      answer:
        "サブスクの契約変更があった場合は、アップセル・ダウンセルに関わらず客報で報告します。客報にはサブスクプラン変更の欄が追加されているため、プラン変更が発生したらその欄で報告を上げてください。変更内容や金額に迷う場合は、本部へ確認してから入力してください。",
      structured: {
        title: "サブスクプラン変更の客報",
        conclusion: "契約変更があったら、アップセル・ダウンセル問わず客報で報告します。",
        reason: "サブスクプラン変更欄が追加されたため、契約変更の履歴を客報側でも把握できるようにするためです。",
        note: "変更内容や金額に迷う場合は、本部確認後に入力してください。",
        detail:
          "サブスクプラン変更が発生した場合は、アップセルでもダウンセルでも報告対象です。客報のサブスクプラン変更欄から報告してください。",
        nextQuestions: ["サブスクの役務報告は必要？", "サブスク解約は店舗でできますか？", "サブスク登録方法は？", "サブスクの繰越ルールは？"],
      },
    },
    {
      id: "menu-pricing",
  ...
  const extraManualSections = [
    ...
    { label: "眼病・施術可否", icon: "◇", question: "眼病の施術可否について教えてください" },
    ...
    { label: "福利厚生", icon: "□", question: "福利厚生について教えてください" },
  ];
  ...
  const categorySuggestions = {
    ...
    "会計・システム": ["サブスクの役務報告は必要ですか？", "サブスクプラン変更時の客報は？", "Squareの通常決済方法は？", "サブスク登録方法は？"],
    ...
    福利厚生: ["アイケアグラスの社割価格を教えてください", "施術割引について教えてください", "メモリックの社割価格はいくらですか？", "エクシブ利用について教えてください"],
    ...
    "眼病・施術可否": ["網膜剥離後は施術できますか？", "緑内障の施術可否は？", "白内障手術後はいつから？", "硝子体出血後はいつから？"],
  };
