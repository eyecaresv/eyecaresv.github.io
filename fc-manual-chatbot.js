(function () {
  ...
  const knowledgeBase = [
    ...
    {
      id: "square-terminal-setup",
      category: "会計・システム",
      title: "Square決済端末の設定",
      keywords: ["Square", "スクエア", "決済端末", "ターミナル", "リーダー", "設定", "現金管理", "二段階認証", "2段階認証", "ログイン"],
      answer:
        "Square決済端末は、ターミナルの場合は本部から共有されたメールアドレスとパスワードでログインし、モードはスタンダードにします。現金管理を使う場合は、その他、設定、おすすめの機能を管理、アドオン、現金管理の順に進み、この端末で使用するをオンにしてください。2段階認証は設定せず、表示された場合は毎回「次回確認する」を選択します。",
      structured: {
        title: "Square端末設定",
        conclusion: "ログイン後、モードはスタンダード。現金管理を使う場合は端末設定でオンにします。",
        reason: "会計と現金管理を店舗で正しく行うため、端末側の初期設定が必要です。",
        note: "2段階認証は設定しないでください。表示された場合は「次回確認する」を選択します。",
        detail:
          "ターミナルは本部から共有されたメールアドレスとパスワードでログインします。現金管理は、その他 > 設定 > おすすめの機能を管理 > アドオン > 現金管理の順に進み、「この端末で使用する」をオンにします。リーダー利用の場合はSquare POSアプリをスマホまたはタブレットにインストールしてログインします。",
        nextQuestions: ["SquareのPCログイン方法は？", "通常決済のやり方は？", "商品ライブラリ決済とは？", "サブスク登録方法は？"],
      },
      links: [{ label: "Square POSアプリ", url: "https://apps.apple.com/jp/app/square-point-of-sale-pos/id335393788?l=en-US" }],
    },
    {
      id: "square-pc-login",
      category: "会計・システム",
      title: "Square PC・iPadログイン",
      keywords: ["Square", "スクエア", "PC", "iPad", "ログイン", "ログインURL", "メールアドレス", "パスワード", "二段階認証", "2段階認証"],
      answer:
        "PC・iPadからSquareへログインする場合は、SquareログインURLを開き、本部から共有されたメールアドレスとパスワードでログインします。ログイン情報を忘れた、または共有されていない場合は本部黒澤さんへ確認してください。2段階認証は設定せず、表示された場合は毎回「次回確認する」を選択します。",
      structured: {
        title: "Squareログイン",
        conclusion: "SquareログインURLから、共有済みのメールアドレスとパスワードで入ります。",
        reason: "PC・iPadでは管理画面からサブスク情報や決済情報を確認するためです。",
        note: "2段階認証は設定しないでください。ログイン情報が不明な場合は本部黒澤さんへ確認してください。",
        detail:
          "ログインURLを開き、メールアドレスとパスワードを入力します。ログイン情報は本部から共有されたものを使用します。お客様の支払い情報は、PCでログイン後「サブスクリプション」のページで確認できます。",
        nextQuestions: ["サブスク登録方法は？", "サブスク解約は店舗でできますか？", "通常決済のやり方は？", "決済ブランドの確認方法は？"],
      },
      links: [{ label: "Squareログイン", url: "https://app.squareup.com/login?lang_code=ja-jp" }],
    },
    {
      id: "square-payment-keypad",
      category: "会計・システム",
      title: "Square通常決済・キーパッド",
      keywords: ["Square", "スクエア", "通常決済", "決済方法", "キーパッド", "メモ", "ポイント", "割引", "お会計"],
      answer:
        "Squareで任意金額やポイント値引き・割引がある決済をする場合は、右下の「お会計」をタッチし、左上の「キーパッド」を開きます。金額を入力したら、金額下の「+メモ」をタッチして内容を残し、「保存」してから決済に進みます。メモには初回4,980円、ポイント500円など、後から見て分かる内容を入れてください。",
      structured: {
        title: "通常決済・キーパッド",
        conclusion: "割引やポイントがある場合は、キーパッドで金額入力し、必ずメモを残します。",
        reason: "後から会計内容を確認できるようにするためです。",
        note: "メモがないと、日計や客報との照合がしにくくなります。",
        detail:
          "操作は、右下「お会計」> 左上「キーパッド」> 任意金額入力 > 金額下の「+メモ」> 内容入力 > 保存 > 決済です。ポイント値引き、割引、特別金額のときに使います。",
        nextQuestions: ["商品ライブラリ決済とは？", "決済を取り消すには？", "返金対応の手順は？", "日計や客報の修正依頼は？"],
      },
    },
    {
      id: "square-payment-library",
      category: "会計・システム",
      title: "Square通常決済・商品ライブラリ",
      keywords: ["Square", "スクエア", "商品ライブラリ", "通常決済", "会計", "商品選択", "取り消し", "個数", "保存"],
      answer:
        "ポイント値引きや割引がない通常決済は、商品ライブラリから決済します。右下の「お会計」をタッチし、上部中央の「商品ライブラリ」を開き、対象商品を選択します。選択後は下部の黒いボタン、「お会計」、「確認と支払い」の順に進みます。商品選択を間違えた場合は、選択した商品をタッチし、個数を0にして保存します。",
      structured: {
        title: "商品ライブラリ決済",
        conclusion: "割引がない通常決済は、商品ライブラリから商品を選んで会計します。",
        reason: "登録済みの商品を使うことで、金額ミスを防ぎやすくなります。",
        note: "選択を間違えた場合は、対象商品の個数を0にして保存してください。",
        detail:
          "操作は、お会計 > 商品ライブラリ > 対象商品を選択 > 下部の黒いボタン > お会計 > 確認と支払いです。カード支払いはそのまま進み、他の決済方法の場合は戻る矢印から希望の決済方法を選びます。",
        nextQuestions: ["キーパッド決済とは？", "返金対応の手順は？", "決済ブランドの確認方法は？", "日計や客報の修正依頼は？"],
      },
    },
    {
      id: "square-subscription-registration",
      category: "会計・システム",
      title: "Squareサブスク登録",
      keywords: ["Square", "スクエア", "サブスク", "サブスクリプション", "登録", "QRコード", "料金表", "1回限り", "決済リンク"],
      answer:
        "サブスク登録は、料金表のQRコードをお客様のスマホで読み取ってもらい、「サブスクリプション」を必ず選択してもらいます。次画面でお客様が情報を入力すると登録完了です。誤って「1回限り」を選んだ場合は、支払い金額にズレが出ないよう注意しながら、再度登録操作を行ってもらいます。",
      structured: {
        title: "サブスク登録",
        conclusion: "料金表QRから入り、必ず「サブスクリプション」を選択してもらいます。",
        reason: "「1回限り」を選ぶと、継続課金として登録されないためです。",
        note: "サブスク解約操作は店舗で行わず、本部黒澤さんへ連絡してください。",
        detail:
          "流れは、料金表QRをお客様のスマホで読み取り > サブスクリプションを選択 > お客様情報入力 > 登録完了です。支払い情報はPCでログイン後、サブスクリプションページで確認できます。",
        nextQuestions: ["サブスク解約は店舗でできますか？", "サブスク変更時に伝える情報は？", "サブスクの繰越ルールは？", "サブスクの領収書は？"],
      },
    },
    {
      id: "square-subscription-change-cancel",
      category: "会計・システム",
      title: "サブスク解約・変更・一時停止",
      keywords: ["サブスク", "サブスクリプション", "解約", "キャンセル", "プラン変更", "一時停止", "黒澤", "SV報告", "解約希望月", "変更希望月"],
      answer:
        "サブスクの解約、プラン変更、一時停止は、店舗で勝手に操作せず、必ず本部黒澤さんへ連絡してください。連絡時は、顧客名、現在使用しているプランと登録日、解約希望月または変更希望月、変更後プランと金額を提示します。支払い日が近いと対応が間に合わない可能性があるため、余裕を持って連絡してください。",
      structured: {
        title: "サブスク変更・解約",
        conclusion: "店舗で操作せず、必ず本部黒澤さんへ連絡します。",
        reason: "支払い日や契約情報に関わるため、店舗側で操作すると金額ズレや処理漏れが起きやすいためです。",
        note: "SV報告後に操作してください。支払い日から余裕を持って連絡する必要があります。",
        detail:
          "連絡時に必要な情報は、顧客名（漢字・カタカナ）、現在使用しているプランと登録日、解約希望月または変更希望月、変更後プランと金額です。原則は、お客様から店舗へ申し出、店舗スタッフが本部黒澤さんへ報告、本部がキャンセル操作をして完了です。",
        nextQuestions: ["サブスク登録方法は？", "サブスクの繰越ルールは？", "サブスクの領収書は？", "Squareログイン方法は？"],
      },
    },
    {
      id: "square-payment-brands",
      category: "会計・システム",
      title: "受付可能な支払ブランド確認",
      keywords: ["Square", "スクエア", "支払ブランド", "決済ブランド", "カードブランド", "店舗", "加盟店", "確認方法", "追加資料"],
      answer:
        "受付可能な支払ブランドは、Squareのホーム画面から、設定、アカウントと設定、加盟店さまの事業、店舗の順に進み、該当店舗を開いて確認します。追加資料の提出を求められている場合は、店舗側で操作せず本部へ連絡してください。",
      structured: {
        title: "支払ブランド確認",
        conclusion: "Squareの店舗設定画面から確認します。",
        reason: "店舗ごとに受付可能な決済ブランドが表示されるためです。",
        note: "追加資料の提出を求められている場合は、操作せず本部へ連絡してください。",
        detail:
          "操作は、ホーム画面 > 設定 > アカウントと設定 > 加盟店さまの事業 > 店舗 > 該当店舗です。右側に表示されるポップアップ内で確認します。",
        nextQuestions: ["Squareログイン方法は？", "通常決済のやり方は？", "返金対応の手順は？", "サブスク登録方法は？"],
      },
    },
    {
      id: "square-subscription-plan-create",
      category: "会計・システム",
      title: "Squareサブスクプラン作成",
      keywords: ["Square", "スクエア", "サブスクプラン", "プラン作成", "サブスクリプションプラン", "サービスと商品", "決済リンク", "QRコード"],
      answer:
        "Squareでサブスクプランを作成する場合は、作成前に本部黒澤さんへ連絡してください。操作は、ホーム、サービスと商品、サブスクリプションプラン、プランを作成の順に進みます。プラン名は店舗名＋商品名、商品の割り当ては商品名と一致する商品、頻度は月1を選択します。他の頻度を使う場合も本部確認が必要です。",
      structured: {
        title: "サブスクプラン作成",
        conclusion: "作成前に本部黒澤さんへ連絡してから操作します。",
        reason: "プラン名、商品割り当て、頻度を誤ると決済リンクや請求にズレが出るためです。",
        note: "頻度は基本「月1」です。他の頻度を使用する場合は本部確認が必要です。",
        detail:
          "操作は、ホーム > サービスと商品 > サブスクリプションプラン > プランを作成です。プラン名は店舗名＋商品名、商品の割り当ては商品名と一致する商品、頻度は月1。保存後、決済リンクやQRコードを発行して使用します。",
        nextQuestions: ["サブスク登録方法は？", "サブスク解約は店舗でできますか？", "Squareログイン方法は？", "サブスク料金を教えて"],
      },
    },
    {
      id: "refund-process",
  ...
  const extraManualSections = [
    ...
    { label: "Square", icon: "▤", question: "Square操作について教えてください" },
  ...
  const categorySuggestions = {
    ...
    "会計・システム": ["Squareの通常決済方法は？", "サブスク登録方法は？", "サブスク解約は店舗でできますか？", "返金対応の手順を教えてください"],
    ...
    Square: ["Squareの端末設定方法は？", "SquareのPCログイン方法は？", "Squareの通常決済方法は？", "サブスク登録方法は？"],
  };
