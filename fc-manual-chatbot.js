  ...
  const knowledgeBase = [
    {
      ...
      answer:
        "サブスクでお通いのお客様には、直営店では基本的に月々のお支払いごとに電子領収書を発行しています。月2回サブスクの場合も、例として「5月分 28,000円」のように、該当月のお支払い金額に対して電子領収書を発行する運用で問題ありません。",
    },
    {
      id: "refund-guarantee",
      category: "契約・返金",
    ...
    },
    {
      ...
      answer:
        "HPBクーポンは、基本的には通常の4,980円クーポンでの掲載を推奨しています。知人や紹介の方こそ、応援やお祝いの気持ちも含め、適正価格で来店いただけるケースが多いためです。プレオープン期間限定で特別クーポンを追加する場合は、1,980円までであれば可能です。その他のクーポン追加や特別価格設定を希望する場合は、事前に本部へ確認してください。",
    },
    {
      id: "ad-metrics",
      category: "広告",
